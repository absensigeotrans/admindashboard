...
import {
  ...
  TrendingDown, Award, AlertCircle, LogOut, Navigation,
  UserCheck, UserX,
} from 'lucide-react';
  ...
  useEffect(() => {
    ...
    const avgHour = weekRecords.length > 0
      ? weekRecords.reduce((s, r) => {
          const timeStr = formatWIBTime(r.check_in_time);
    ...
    // -- Effect 2: Top/Bottom Performers (reuses weekRecords) --
